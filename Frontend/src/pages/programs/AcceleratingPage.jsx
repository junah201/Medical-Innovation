		...
		<Page>
			...
			<StyledStartupSupportWrapper>
				...
				<p>
					...
					연결하고 지원하기 위한 '연구와 연구자에 대한 이해를 갖추면서도 동시에
					공익적 감수성을 갖춘 전문가 집단을 바탕으로 연구기관, 바이오 기업,
					투자자 등을 적정하게 연결할 수 있는 공익적 플랫폼'으로 자리잡기 위해
					중소벤처기업부에 액셀러레이터(창업기획자) 비영리법인으로 등록하고
					재단의 후원사 및 협력기관과 연대하여 유망한 스타트업 발굴, 조기
					기술사업화를 위한 선제적 오픈이노베이션 촉진에 박차를 가하고 있습니다.
