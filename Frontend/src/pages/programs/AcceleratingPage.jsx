		...
		<Page>
			...
			<div>
				...
				<Message>
					...
					연구 및 창업 지원 플랫폼입니다. 신치료기술 개발의 위험성과 장기화된
					과정을 고려하여 지속적인 지원을 통해 차세대 인재들의 우수한 혁신기술이
					조기 상용화될 수 있도록 노력하고 있습니다. 또한 재단 주도의 인적·물적
					네트워크를 적극 활용하여 창업(예정) 기업에 맞춤형 창업 지원 프로그램
					및 선순환 오픈이노베이션을 지원합니다. 이를 통해 창업기업의 지속적인
					성장을 촉진하고, 신치료기술 분야에서의 혁신과 발전에 기여하고자
					합니다.
				</Message>
			</div>
