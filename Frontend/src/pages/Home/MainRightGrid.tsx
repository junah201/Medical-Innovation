...
export const MainRightGrid = () => {
  ...
  const [supportingStartups, setSupportingStartups] =
    useState<SuportingStartup[]>([]);
...
const PostItem = ({
  ...
  try {
    date = new Intl.DateTimeFormat('kr', {}).format(
      new Date(date)
    );
  } catch {
    date = '';
