...
import { SponsoringCompanyList } from '@/types/sponsoringCompany';

export const Sponsors = () => {
  const [sponsorshipStatus, setSponsorshipStatus] =
    useState<SponsoringCompanyList>();

  useQuery(
    'sponsoring_companise',
    () => getSponsoringCompanies(0, 1000),
    {
      retry: false,
      onSuccess: (res) => {
