			...
			<StyledMissionWrapper>
				...
				<div>
					<p>
						...
						기초의학 연구와 이를 활용한 융복합연구를 발굴 수행해 나갈 것입니다.
						<br />
						즉, 세포생물학과 나노바이오테크놀로지를 융합한 미래융합형 연구를
						선도함과 동시에 이로부터 도출된 첨단 치료법 혹은 신치료기기를 환자에
						적용하는 것을 촉진하도록 하겠습니다. 셋째, 이러한 융복합 연구를
						창의적으로 구현할 유망한 의과학자를 지원 육성할 것입니다. 넷째,
						혁신적 연구아이디어와 개발된 기술이 효율적으로 확산되도록
						연구생태계를 발전시켜 나갈 것입니다.
						<br />
