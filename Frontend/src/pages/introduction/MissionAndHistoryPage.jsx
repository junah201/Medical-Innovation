...
const StyledMissionAndHistoryPage = styled.main`
	display: flex;
	justify-content: center;
	padding: 20px;
`;

const StyledMissionAndHistoryWrapper = styled.div`
...
const MissionAndHistoryPage = () => {
	return (
		<StyledMissionAndHistoryPage>
			<StyledMissionAndHistoryWrapper>
				...
				<StyledMissionWrapper>
					...
					<div>
						<p>
							미래의학연구재단은 첫째, 미래의학을 선도할 유망 기술 연구 동향을
							정기적으로 면밀히 조사하고 그 정보를 적기에 공급함으로써, 대한민국
							의학 연구수준을 세계적인 수준으로 높이는 계기를 만들어갈 것입니다.
							둘째, 창의적 아이디어가 환자에게까지 적용될 수 있도록, 신개념의
							기초의학 연구와 이를 활용한 융복합연구를 발굴 수행해 나갈
							것입니다.
							<br />
							즉, 세포생물학과 나노바이오테크놀로지를 융합한 미래융합형 연구를
							선도함과 동시에 이로부터 도출된 첨단 치료법 혹은 신치료기기를
							환자에 적용하는 것을 촉진하도록 하겠습니다. 셋째, 이러한 융복합
							연구를 창의적으로 구현할 유망한 의과학자를 지원 육성할 것입니다.
							넷째, 혁신적 연구아이디어와 개발된 기술이 효율적으로 확산되도록
							연구생태계를 발전시켜 나갈 것입니다.
							<br />
