...
const StyledChairmanMessagePage = styled.main`
	display: flex;
	justify-content: center;
	padding: 20px;
`;
const StyledChairmanMessageWrapper = styled.div`
...
const ChairmanMessagePage = () => {
	return (
		<StyledChairmanMessagePage>
			<StyledChairmanMessageWrapper>
				<SubNav select="이사장 인사" />
				<StyledChairmanProfile>
					<img src={jeonSeungho} alt="전승호" height="300px" />
					<div>
						<h2>
							<span>전승호</span>
						</h2>
				...
				<StyledChairmanMessageContent>
					...
					아이디어와 유망 기술의 최신동향을 적기에 공급하고 최신 치료기술을
					효과적으로 전파하여 세계적인 연구 및 창업생태계 조성과과 조기
					기술실용화를 도모할 목적으로 설립된 과기부 산하 비영리법인이며
					중소벤처기업부 등록 창업기획자자입니다.
					<br />
					...
					성장 지원하여 기업의 지속성장을 도모하고 이를 통해 긍국적으로로
					대한민국 미래성장동력에 이바지하는 공익을 실현하하겠습니다.
					<br />
					재단법인 미래의학연구재단 이사장
				</StyledChairmanMessageContent>
			</StyledChairmanMessageWrapper>
