  ...
  return (
    <>
      ...
      <Message>
        ...
        <br />
        <br />
        26년간 “심혈관・줄기세포・생물학” 분야에만 매진하면서 거둔 연구의 업적은
        줄기세포 생물학의 독창적인 기초연구 성과를 진료 현장에 도입해 심근경색
        치료법인 ‘매직셀’이라는 혁신의료기술을 확립했다. 또 세포생물학 연구를
        바탕으로 심근 재생을 위한 세포유전자 치료법 및 대사질환·지방간 치료법
        개발, 패혈증 치료제 개발 등에서 괄목할만한 성과를 도출하였습니다.
        연구실적에서도 그의 논문들의 피인용 회수 총합계가 4만4천여 회를
        상회하며, 그 동안 Lancet, Cell Stem Cell, European Heart J, Circulation,
        Cell Metabolism, J Am College Cardiology, Blood, Cell Research, EMBO J
        등 임팩트팩터가 10이상인 잡지에 출판한 논문의 수가 191여편에 달하며,
        H-INDEX가 99에 도달하고 있습니다.
        <br />
        <br />
        김효수 교수는 탁월한 연구 성과를 인정받아서 2008년도 1회 아산의학상
        대상을 수여하였고, 2014년도에 분쉬의학상 본상을 수상하였으며, 수훈내용이
        탁월한 연구성과로서는 처음으로 2016년 대통령 훈장인 근정훈장을
        수상하였습니다.
        <br />
        <br />
